...
def build():
    ...
    add_table('data/raw/fantasy_matchup_next4.csv', 'Fantasy: Best/Worst Matchups (Next 4 Weeks)', sort_by='week', ascending=True, top_n=128)

    # --- Full season schedule grid (from fetch_schedule_grid.py) ---
